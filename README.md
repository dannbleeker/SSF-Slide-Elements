...
| Host probe — a Script Lab snippet that asks a real PowerPoint the eight questions the design rests on (a pruned package on the way in, insert-then-delete order, the selected slide, which read of the deck, Ctrl+Z, timing and the floor, moving to a slide, and what the slide listing says about a slide just inserted), and a reader that says what each answer means and files the sheet | done — ten sheets under `docs/host-answers/`: six from PowerPoint for the web (four 2026-09-10, two 2026-09-14) and four from Windows (two 2026-09-11, two 2026-09-14). Questions 1 to 7 are answered on both platforms; question 8, added 2026-09-24 for the Undo, has not been asked yet |
